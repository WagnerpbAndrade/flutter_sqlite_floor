...
class _$AppDatabase extends AppDatabase {
  ...
  TodoRespositoryDao _todoRepositoryDaoInstance;
  ...
  TodoRespositoryDao get todoRepositoryDao {
    return _todoRepositoryDaoInstance ??=
        _$TodoRespositoryDao(database, changeListener);
  }
}

class _$TodoRespositoryDao extends TodoRespositoryDao {
  _$TodoRespositoryDao(this.database, this.changeListener)
  ...
  @override
  Future<TodoEntity> getAll() async {
    return _queryAdapter.query('SELECT * FROM Todos', mapper: _todosMapper);
  }
